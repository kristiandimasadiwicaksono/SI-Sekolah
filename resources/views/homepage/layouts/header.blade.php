        ...
        <div class="py-2 md:py-0  flex flex-col md:flex-row md:items-center gap-0.5 md:gap-1">
          <div class="grow">
            <div class="flex flex-col md:flex-row md:justify-end md:items-center gap-0.5 md:gap-1">
              ...
              <a class="p-2 flex items-center text-sm rounded-lg {{ request()->routeIs('siswa.index') ? 'bg-gray-200 text-gray-800' : 'text-gray-800 hover:bg-gray-100' }}" href="{{ route('siswa.index') }}" aria-current="page">
