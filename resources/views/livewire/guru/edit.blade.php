  ...
  <form method="POST" action="{{ route('guru.update', $guru->id) }}">
    ...
    <div class="py-6 first:pt-0 last:pb-0 border-t first:border-transparent border-gray-200">
      ...
      <div class="mt-1 mb-2 space-y-3">
        <input id="nama" name="nama" type="text" value="{{ old('nama', $guru->nama) }}" class="py-1.5 sm:py-2 px-3 block w-full border border-gray-200 shadow-2xs sm:text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" placeholder="Masukkan nama lengkap" required>
        @error('nama')
      ...
      <div class="mt-1 mb-2 space-y-3">
        <input id="nip" name="nip" type="text" pattern="[0-9]+" maxlength="20" value="{{ old('nis', $guru->nip) }}" class="py-1.5 sm:py-2 px-3 block w-full border border-gray-200 shadow-2xs sm:text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none " placeholder="Masukkan NIS" required>
        @error('nip')
      ...
      <label for="alamat" class="inline-block text-sm font-medium">
        ...
        <div class="mt-1 mb-2 space-y-3">
            <textarea id="alamat" name="alamat" rows="3" class="py-1.5 sm:py-2 px-3 block w-full border border-gray-200 shadow-2xs sm:text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" placeholder="Masukkan alamat" required>{{ old('alamat', $guru->alamat) }}</textarea>
        </div>
    </div>
