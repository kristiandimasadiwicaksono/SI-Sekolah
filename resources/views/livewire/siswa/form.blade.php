<div>
    <form method="POST" action="{{ route('siswa.store') }}">
      ...
      <div class="py-6 first:pt-0 last:pb-0 border-t first:border-transparent border-gray-200">
        ...
        <div class="mt-1 mb-2 space-y-3">
          <input id="nis" name="nis" type="number" value="{{ old('nis') }}" class="no-spinner py-1.5 sm:py-2 px-3 block w-full border border-gray-200 shadow-2xs sm:text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" placeholder="Masukkan NIS" required>
          @error('nis')
